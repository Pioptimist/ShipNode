        ...
        <div className="relative border border-foreground/10 bg-background/50 backdrop-blur-md rounded-3xl p-8 sm:p-12 shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">
              Sign in to your account and manage your deployments
            </p>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-foreground/10 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/signup" className="text-foreground hover:underline underline-offset-4 decoration-foreground/30 font-medium transition-colors">
                Sign up
              </Link>
            </p>
          </div>
