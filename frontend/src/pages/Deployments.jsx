                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <a href={`https://${project.subdomain}.${import.meta.env.VITE_PLATFORM_DOMAIN}`} target="_blank" rel="noreferrer" className="text-sm text-blue-400 hover:underline">
                        {deploy.subdomain}.shipnode.soumyodeep.online
                      </a>
                    </div>
